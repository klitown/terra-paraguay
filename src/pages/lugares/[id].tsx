        ...
        <>
            ...
            <Card className="mt-10 p-12 rounded-3xl">
                <div className="flex flex-col md:flex-row justify-center items-center">
                    ...
                    <div className="basis-1/2">
                        <p>
                            Omni Orlando Resort at ChampionsGate se encuentra en el área de Four Corners en Kissimmee, en las afueras y cerca del aeropuerto.
                            Aquellos que quieran ir de compras pueden visitar Complejo de entretenimiento Old Town, mientras que quienes deseen conocer los puntos de interés más populares de la zona pueden ir a Parque temático Disney's Animal Kingdom® y Epcot®.
                            ¿Viajas con niños? No te pierdas Walt Disney World®, o asiste a un evento o partido en Complejo ESPN Wide World of Sports.
                            Encontrarás muchas opciones para disfrutar del aire libre con actividades como tours ecológicos.
                        </p>
                    </div>
                </div>
            </Card>
            ...
            <Card className="mt-10 p-12 rounded-3xl">
                <div className="flex flex-col md:flex-row justify-center items-center">
                    ...
                    <div className="basis-1/2">
                        <div className="flex flex-col">
                            <h4 className="text-xl font-bold mb-3 text-blue-700">📍 Qué hay cerca</h4>
